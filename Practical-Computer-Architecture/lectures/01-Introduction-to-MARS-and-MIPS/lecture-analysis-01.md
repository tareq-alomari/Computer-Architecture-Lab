...
- **دليل MARS (PDF):** `tools/شرح العمل على برنامج mars.pdf` — دليل مصور يشرح جميع خطوات العمل
- **حزمة الأدوات:** `tools/CA-Tools.rar` — تحتوي على MARS (`Mars4_3.jar`)، Java JRE، Logisim
